...
const settings = {
  packname:    process.env.STICKER_PACKNAME || 'BLACK-DEMON',
  author:      process.env.STICKER_AUTHOR   || 'Jinwiil Onginjo',
  botName:     process.env.BOTNAME          || 'BLACK-DEMON',
  ...
  description: 'BLACK-DEMON WhatsApp Bot with Best Commands',
  version:     '3.0.0',
  ytChannel:   process.env.YT_CHANNEL       || '',
  updateZipUrl: 'https://github.com/Finjohns/Black-Demon/archive/refs/heads/main.zip',
};
